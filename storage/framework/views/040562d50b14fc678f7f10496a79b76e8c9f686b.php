                        ...
                        <form href="<?php echo e(__('/verify')); ?>" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group mb-4">
                                    <input type="text" class="form-control" id="code" onclick="select()" name="code" value="<?php echo e(auth()->user()->provider_id); ?>" readonly="">
                    ...
                    <div class="card-body px-lg-5 py-lg-5">
                        ...
                        <div>
                            <div style="width: 100%px; height: 485px; overflow-y: scroll;">
                                <div class="fb-comments" data-href="<?php echo e(env('APP_URL')); ?>verify" data-width="100%" data-numposts="5"></div>
                            </div>
                        </div>
                    </div>
                </div>
